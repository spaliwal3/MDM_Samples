<?php  
$cancel_url = '';
if ( false === strpos($post_url, '?') ) {
    $cancel_url = $post_url.'?uid='.$user_id.'&cancel';
} else {
    $cancel_url = $post_url.'&uid='.$user_id.'&cancel';
}
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://gallery.mailchimp.com/f2842a31f2eecf4a4d37a597d/images/a3736f94-7970-40c9-bb90-b090f46eb812.png" width="250" style="max-width:738px; margin:0 auto; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">    
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width:100%;" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                            ...
                            <h1 style="font-size:1.25em;">Hi '.$first_name.',</h1>
                            <p>This is your registration confirmation for program <strong style="font-size:1.125em;"> '.$course_name.'</strong></p>
                            <p style="margin:32px 0;"><a class="mc-template-link" href="'.$post_url.'" style="padding: 12px; text-decoration: none; background-color: #5cb85c; color: #fff; border-radius: 4px;">View My Program</a></p>
                            <p style="padding:12px;border:1px solid #d9d9d9;"><strong>Payment Information: </strong>'.$payment_pref.'</p>
                            
                            <p>You may cancel attendance in the course <a class="mc-template-link" href="'.$cancel_url.'">here</a>. If you cancel within 30 days of the course your check will be deposited, otherwise, it will be returned.</p>
                        </td>
                    </tr>
                </tbody></table>
                                                                    ...
                                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="">
                                                                        <tbody><tr>
                                                                                ...
                                                                                <td align="center" valign="middle" width="24" class="mcnFollowIconContent">
                                                                                    <a href="https://www.facebook.com/Georgia-Trauma-Foundation-373326299522113" target="_blank"><img src="http://cdn-images.mailchimp.com/icons/social-block-v2/color-facebook-48.png" style="display:block;" height="24" width="24" class=""></a>
                                                                                </td>
                                                                ...
                                                                <td align="left" valign="middle" style="padding-top:5px; padding-right:10px; padding-bottom:5px; padding-left:9px;">
                                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="">
                                                                        <tbody><tr>
                                                                                ...
                                                                                <td align="center" valign="middle" width="24" class="mcnFollowIconContent">
                                                                                    <a href="http://georgiatraumafoundation.org" target="_blank"><img src="http://cdn-images.mailchimp.com/icons/social-block-v2/color-link-48.png" style="display:block;" height="24" width="24" class=""></a>
                                                                                </td>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width:100%;" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                            ...
                            <em>Copyright © 2015 Georgia Trauma Foundation, All rights reserved.</em>
